document.addEventListener("DOMContentLoaded", () => {
  ...
  // URL del backend Flask locale definito nel notebook (HOST/PORT), che inoltra le
  // richieste a Ollama. Se il server gira su un'altra macchina o porta, aggiorna questa
  // costante (es. "http://192.168.1.10:8080/").
